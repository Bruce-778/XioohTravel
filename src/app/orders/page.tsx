      ...
      <div className="mt-6">
        <OrdersClient
          ...
          labels={{
            ...
            cancelRuleHint: t("footer.ruleText"),
            ...
            activeBookings: t("orders.activeBookings"),
            noActiveBookings: t("orders.noActiveBookings"),
            cancelledArchive: t("orders.cancelledArchive"),
            showCancelledArchive: t("orders.showCancelledArchive"),
            hideCancelledArchive: t("orders.hideCancelledArchive"),
            ...
            refundStatus: t("orders.refundStatus"),
            refundAmount: t("orders.refundAmount"),
            refundOriginalAmount: t("orders.refundOriginalAmount"),
            refundProcessingFee: t("orders.refundProcessingFee"),
            refundEstimatedAmount: t("orders.refundEstimatedAmount"),
            refundFeeDeducted: t("orders.refundFeeDeducted"),
            refundFeeDisclosure: t("orders.refundFeeDisclosure"),
            refundSettlementNote: t("orders.refundSettlementNote"),
            refundPreviewLoading: t("orders.refundPreviewLoading"),
            refundPreviewFailed: t("orders.refundPreviewFailed"),
            refundRequestedAt: t("orders.refundRequestedAt"),
            ...
            refundFailed: t("orders.refundFailed"),
            refundCancelTip: t("orders.refundCancelTip"),
